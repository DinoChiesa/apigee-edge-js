...
// last saved: <2017-May-03 19:53:34>
...
//require('request-debug')(request);
  ...
  function invokeTokenEndpoint(conn, formparams, cb) {
    ...
    request.post(requestOptions, commonCallback(conn, [200], function(e, result) {
      // if (e && conn.verbosity>0) {
      //   utility.logWrite(sprintf('token result %s', JSON.stringify(result)));
      // }
      if ( ! e && result) {
  ...
  FlowHook.prototype.get = function(options, cb) {
    // GET :mgmtserver/v1/o/:orgname/e/flowhooks
    // or
    // GET :mgmtserver/v1/o/:orgname/e/flowhooks/NAMEOFFLOWHOOK
